"""MarbleTrace UI: interactive latent trajectory explorer.
...
def run_pipeline(cfg: MarbleConfig, prompt: str, model=None, tokenizer=None) -> dict:
    """Execute the full MarbleTrace pipeline and return every artifact.
...
def render(
    ...
    fig.update_layout(
        ...
        title={"text": "MarbleTrace — latent trajectory explorer", "font": {"size": 14}},
    )
    return fig
...
def main() -> None:
    ...
    st.set_page_config(page_title="MarbleTrace", page_icon="🔮", layout="wide")
